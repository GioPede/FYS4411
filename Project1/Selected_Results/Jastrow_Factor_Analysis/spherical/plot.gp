...
set output 'plot_jastrow_sphere.png'
#set xformat "%.0f"
#set yformat "%.0f"
set xrange [0.1:0.75]
#set yrange [0:2]
...
set title "Spherical Trap Interaction Contribution"

# Plot del modulo
plot  '10.csv'  u ($1):($6):($7) ls 1 w yerrorbars ti sprintf("10 particles"),\
	  '50.csv'  u ($1):($6):($7) ls 6 w yerrorbars ti sprintf("50 particles"),\
	  '100.csv' u ($1):($6):($7) ls 4 w yerrorbars ti sprintf("100 particle")
